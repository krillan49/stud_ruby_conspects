...
# В сдучае если фориа передает на GET(<form aсtion="GET"...), то параметры все равно есть в params[:чето], тоже касается запросов PUT, DELETE, хоть они и передаются по другому
