...
# метод post обслуживает post-запросы(когда браузер хочет отправить данные например логин и пароль) со страницы, те обрабатывает данные которые браузер отправил к нам на сервер
