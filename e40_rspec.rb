...
puts
# before
# У нас часто повторяется код hero = Hero.new 'foo', и это не совпадает с DRY (Don`t Repeat Yourself), потому оптимизируем, добавив before-do-end. Но главное чтобы была хорошая читаемость, во вред ей DRY использовать не стоит.
require './hero'
