...
p filename = File.basename(file) #=> "simple2.txt"
p bname = File.basename(file,".txt") #=> "simple2" # 2й аргумент удаляет расширение
p extention = File.extname(file) #=> ".txt"
p path_name= File.dirname(file) #=> "ruby_exemples/text"
