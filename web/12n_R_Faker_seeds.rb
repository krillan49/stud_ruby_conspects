...
# https://github.com/faker-ruby/faker   -  описание, генераторы и прочая инфа
...
# gem 'faker', '~> 3'   -  поместить в Gemfile для Рэилс или Синатры. '~> 3' актуальную версию смотрим в документации(тут версия не от 3х но не 4)
# > bundle install
