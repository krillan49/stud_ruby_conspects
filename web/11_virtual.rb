...
# hyper-v доступна только на w10pro. но на home виртуалка тоже спокойно работает и без этой галочки
# 15 Гб это слишком мало. Она крашнется. Так как диск динамический, то можно хоть 2 Тб выделить.
# И в Windows компонент Hyper-V лучше не включать, чтобы не тормозило
