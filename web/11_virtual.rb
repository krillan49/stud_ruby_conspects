...
# Виртуальная машина (VM) - это виртуализация или эмуляция компьютерной системы. Виртуальные машины основаны на компьютерных архитектурах и обеспечивают функциональность как у физического компьютера

# Виртуальная машина изолирована. Гостевая система работает в полностью изолированной среде, те любые манипуляции в гостевой системе, не повлияет на хост-систему.
