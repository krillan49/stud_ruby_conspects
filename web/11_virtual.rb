...
# На Линукс Ubuntu (виртуальном) общая папка находится в директории /media (Фаилы скриптов в общей папке лучше создавать в виртуальном линукс, чтобы работали корректно)
