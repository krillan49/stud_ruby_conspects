...
# б. "Система/Sistem" - содержит подразделы: Материнская плата/Motherboard(убедимся что поставлены галочки на 'Включить I/O APIC' и 'Часы в системе UTS'); Процессоры/Processor(можно изменить колличесво выделенных ядер процессора физическим компьютером для нашей виртуальной машины); Ускорение/Acceleration (7-51 у гоши дударя, но вроде в коментах пишут что не надо) (Из комментов) hyper-v доступна только на w10pro, а на home виртуалка спокойно работает и без этой галочки. И в Windows компонент Hyper-V лучше не включать, чтобы не тормозило
