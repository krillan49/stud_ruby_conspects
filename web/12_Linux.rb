...
puts
puts '                                        Пакетный менеджер Линукс'
...
# 4. apt-cache search - команда которая ищет пакет(приложкение) в стандартном репозитории. Может искать по неполному названию и прелагать варианты в зависимости соотв введенных символов.
# $ apt-cache search bluefi      - выдаст список программ в названии которых есть "bluefi"


# 5. apt-cache policy - команда которая ищет пакет(приложкение) на вашем ПК
