...
# Если строка (тут name) окажется содержащей ', то это завершит строку в операторе SQL, что вызовет ошибку; или что еще хуже, если злоумышленник сделает эксплойт SQL-инъекции. Cледует избегать построения SQL-запроса путем интерполяции или добавления строк; исправлять это способом отфильтровывания или цитирования неправильных символов, будет довольно сложно.
