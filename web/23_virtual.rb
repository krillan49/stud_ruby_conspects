...
# !!! Уроки по тестированию без этого будут не очень, тк пакеты для тестирования которые нам нужны не очень хорошо запускаются под винду и хоть будет работать вылезет куча варнингов
