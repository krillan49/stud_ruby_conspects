...
# Вариант 2: Создадим отдельный фаил controllers/concerns/error_handling.rb и обработаем ошибку в нем, а в материнский контроллер его просто подключим через модуль
class ApplicationController < ActionController::Base
