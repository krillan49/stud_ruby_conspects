...
# Вариант 2: Создадим отдельный фаил controllers/concerns/error_handling.rb, который содержит модуль с неоходимыми методами и обработаем ошибку в нем, а в материнский контроллер его просто подключим
class ApplicationController < ActionController::Base
