...
# Тоесть пользователь не ждет пока задача будет выполнена, а может дпльше чето делать в приложении и ничего не подвиснет, тк задача будет выполняться в бэкграунде.
