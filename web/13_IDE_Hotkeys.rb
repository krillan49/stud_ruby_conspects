...
# F5 -> вводим новое имя фаила -> Enter                                - Скопировать фаил под новым именем - наводимся,
...
# Команды внутри текстового фаила в FAR:
...
# Если зайти в фаил через F3 и находясь в нем нажать F4  то выдасть 16ричный код фаила и доп инфу
...
# Ctrl+/Ctrl-                                                    - Увеличить/уменьшить все на экране
...
#   "editor.tabSize": 2
# }
# измените число «4» на количество пробелов, которое вы хотите использовать для отступа.
...
# ctrl+колесико    - изменить размер шрифта в sublime
# tab+shift        - отступ влево
...
# ctrl+колесико  - Размер шрифта в Атом
