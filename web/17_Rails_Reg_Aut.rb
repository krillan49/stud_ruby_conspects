...
# В Рэилс уже есть встроенный метод для модели has_secure_password, для работы с этим гемом и виртуальными атрибутами
...
# 5. Используем session[:user_id] для создания хэлпера текущего пользователя, который проверяет вошел пользователь в систему или нет. Добавим его в application_controller.rb:
