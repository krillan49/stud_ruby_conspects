...
# html_safe - (AR ??) обрабатывает любые теги, что опасно, тк пользователь может ввести теги скрипт с вредоносным js-скриптом, например украдет пароли пользователей тк будет записывать ввод
