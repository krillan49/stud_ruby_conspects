...
# Можно на вкладке сайта в браузере, через тег head->title добалять не только статическое название сайта, но и динамически добавлять тудк название активной страницы.
