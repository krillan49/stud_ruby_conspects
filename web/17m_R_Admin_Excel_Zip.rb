puts '                    Админ. Namespace. format. Импорт/экспорт Excel, архивы ZIP. Сервисные объекты'
...
wb.add_worksheet(name: 'User') do |sheet| # добавляем (?? в документ Excel) новый лист с именем 'User'
  ...
  # style: [nil, highlight_cell] - применяем стиль. К 1й ячейке не применяем стили потому nil, а во второй применяем стили созданные за переменной highlight_cell
