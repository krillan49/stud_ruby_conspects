  ...
  class UsersController < ApplicationController
    def index
      respond_to do |format|
        # respond_to метод принимающий в параметр блока все форматы на которые мы хотим отвечать и этот блок содержит код описывающий как мы будем отвечать на каждый из форматов
