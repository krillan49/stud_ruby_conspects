...
# Запустим миграции(тут с правильным синтаксисом, с гемами из гемфаила)
...
def create
  ...
  respond_to do |format| # если запрос из браузера то возвращает html, а если запрос от JS то возвращает json
    if @user.save
