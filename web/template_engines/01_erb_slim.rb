...
# В приложениях (например Rails) часто используются шаблоны представлений (views) для генерации HTML с помощью встроенного Ruby-кода. Наиболее популярные шаблонизаторы (или template engine те движек шаблонов) - это ERB и Slim
...
# .html.erb либо просто .erb  -  расширения для view-HTML-фаилов (например index.erb)
