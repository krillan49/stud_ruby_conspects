...
class QuestionsController < ApplicationController
  ...
  def set_question! # метод который будет запускаться при помощи before_action, называем с восклиц знаком в конце, те он может вернуть ошибку если не существует такой вопрос
