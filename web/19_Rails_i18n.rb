...
# В Рэилс при соответствии маршрута разделов в yml и последовательности каталогов в приложении(контроллер.представление.ключ) то вместо этой полной последовательности:
