...
class ArticlesController < ApplicationController
  ...
  def create # post '/articles'
    ...
    # render - метод для возврата/вывода данных из экшена, отличных от вида по умолчанию. Выводит по URL экшена create те post '/articles';
...
class ArticlesController < ApplicationController
  ...
  def create
    ...
    if @article.save
      ...
      # Так же аргументами redirect_to можно использовать хэлперы путей или сами юрл адреса
    else
      render action: 'new'
    end
  end
