...
# 3. Создадим сами теги (заполним таблицу) чеорез скрипт в db/seeds.rb при помощи Faker.
...
# app/javascript - создадим подпаку для отдельных скриптов - script (можно и прямо в application.js писать скрипты, но тогда там будет каша)
