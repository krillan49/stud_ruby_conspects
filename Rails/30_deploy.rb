...
# Сделаем деплой приложения Rails, с настройкой для: БД Postgres, Redis, обработкой фоновых задач с Sidekiq и реализовав выполнение заданной на задаче на регулярной основе (по типу Cron):
