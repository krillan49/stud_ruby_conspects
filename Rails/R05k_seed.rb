...
# db/seeds.rb - этот фаил нужен для того чтобы писать скрипты, которые добавляют данные в БД, так же эти скрипты можно писать в миграции, но правильнее всетаки в seeds.rb
...
# Можно начальных пользователей (и роли, если они хранятся в БД)
# db/seeds.rb:
