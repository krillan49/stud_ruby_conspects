...
require 'pagy/extras/bootstrap' # добавили это. Это специальные методы которые будут выводить пагинацию со стилями бутстрэп
...
require 'pagy/extras/i18n' # расскомментируем для переводов
