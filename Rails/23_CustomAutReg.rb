puts '                           Кастомный способ регистрации и аутентификации. bcrypt'
...
# has_secure_password - по умолчанию уже встроенный в Рэилс метод для модели от bcrypt гема для создпния и валидации атрибутов и виртуальных атрибутов для регистрации и аутентификации.
...
# Для этого создадим отдельные маршруты и контроллер для сессий(создания и удаления сессий, тоесть входа и выхода из системы).
