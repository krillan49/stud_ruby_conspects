...
# Роль миграции - это приведение структуры БД (не данных) в соответсвие с нашим кодом, тоесть например таблица имела все поля соответсвующие свойствам модели итд. В каждой миграции есть описание изменений структуры БД. Нужны чтобы развернуть приложение с 0 на другой машине.
...
# Консоль Рэилс - это как irb к которому добавлен функционал Рэилс, тоесть можно писать в ней любой рубикод и рэилскод.
