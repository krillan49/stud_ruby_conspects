...
# Перевод названий моделей - некоторые хэлперы могут его использовать и выводить в представления, например на кнопке формы submit
'activerecord:
   models:
...
# 6. Сделаем меню переключения языков в layouts/application.html.erb  или (AskIt) в shared/_menu.html.erb
