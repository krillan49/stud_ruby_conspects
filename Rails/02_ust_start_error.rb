...
# d public           -  фаилы передаваемые напрямую минуя приложение (статичные), просто в ответ на запрос. Тоесть их можно вызвать написав от корня имя этого фаила. А если создать там index.html то он будет автоматически открываться при заходе на сервер
