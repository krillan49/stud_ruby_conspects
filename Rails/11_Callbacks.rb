...
# какую логику можно помещать в колбеки, а какую нет?
# в callbacks можно ложить простую логику, простые валидации, асинхронные задачи (jobs) так чтобы они не зависели  друг от друга. Принято как можно меньше ответственности ложить на коллбэки, и чаще всего всё перемещать в сервисы, объекты, use_case'ах
