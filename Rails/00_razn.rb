...
# Либо можно вынести какую-то большую логику в сервис и применять его во многих местах. Но минус сервисов в том что на реальных проектах, они начинают использоваться в разных слоях MVC, даже во вьюхах, что не очень хорошо тк нарушает разделение слоев
