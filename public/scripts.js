...
var x = 1; // при перезагрузке страницы(соотв и при переходе на другие страницы) переменные инициализируются заново, те не сохраняются от стpаницы к странице(соотв счет начнется с 1 с каждой новой станицы)
function perx() {
