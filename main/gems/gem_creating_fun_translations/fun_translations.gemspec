require File.expand_path('lib/fun_translations/version', __dir__) # подключаем fun_translations/version в Gem::Specification
...
Gem::Specification.new do |spec|
  ...
  spec.version               = FunTranslations::VERSION  # Версия - можно прописать вручную ввиде строки например '0.0.1', а можно использовать константу из фаила(nen lib/fun_translations/version.rb) в нашем исходном коде
  spec.authors               = ['Ilya Krukowski']        # инфа об авторе
  spec.email                 = ['golosizpru@gmail.com']  # инфа об авторе
  ...
  spec.homepage              = 'https://github.com/bodrovis/fun_translations' # то где лежит исходный код, но можно и просто вебсайт
  spec.license               = 'MIT'    # стандартная лицензия для библиотек с открытым кодом
  spec.platform              = Gem::Platform::RUBY # платформа - Руби
  ...
  # Гемы, которые будут использованы в нашей библиотеке, будут установлены вместе с нашим гемом, тоесть зависимости
