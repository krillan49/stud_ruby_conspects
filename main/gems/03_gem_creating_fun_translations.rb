...
# В любом геме пригодчтся собственные классы исключений, чтобы облегчить жизнь его пользователям
...
# Настроим вызов spec_helper.rb в фаиле .rspec

# Структуру фаилов и директорий тестов желательно формировать так же, как сформирована структура тестируемых фаилов, например содалим директорию /spec/lib
