...
# Иерархия наследования (Inheritance Hierarchy) - это что подклассы наследуют у суперклассов а не наоборот (??)
