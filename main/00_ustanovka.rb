...
# https://www.youtube.com/watch?v=lhRAK_bwaeo&list=PLWlFXymvoaJ-td0fgYNj3fCnCVDTDClRg          - установка в сасмом начале

# https://rubyinstaller.org/downloads/   - установка интерпритатора Руби под виндоус, лкчше выбрать стабильную версию с DevKit выделенную жирным
...
# 1. Все настройки можно оставить по умолчанию, но в конце галочка рядом с "Run 'ridk install' ..." должна стоять
# 2. Далее откроется окно терминала, в нем по очереди:
