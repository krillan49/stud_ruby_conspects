...
# 1. Установите Ruby с помощью установщика Ruby . Выберите свою версию. Я использую последнюю версию. Выберите свою операционную систему: 32 или 64 бит. В этом руководстве я использую x64-версию Ruby, установленную в C:\Ruby200-x64.

# 2. Убедитесь, что вы обновили переменную PATH, указывающую на: C:\Ruby200-x64\bin. Нажмите Win+R, введите cmd , затем введите irb. У вас должен быть irb на вашем пути. Введите ruby ​​-v , чтобы показать версию ruby. Примечание: если вы используете Far Commander или другие коммандеры, вам может потребоваться перезапустить это приложение.
...
# 4. Смените каталог на C:\RubyDevKit  и введите ruby ​​dk.rb init
