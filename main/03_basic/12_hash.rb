...
# 6. Это синтаксический сахар, добавленный в Ruby 2.7+ и поддерживаемый в Rails. Можно использовать такой сокращённый синтаксис только если переменные с такими именами уже существуют в области видимости:
