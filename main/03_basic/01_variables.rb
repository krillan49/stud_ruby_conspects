...
# Присвоение переменной внутри квадратных скобок и сразу использование внутри них же
n = 2
p 'FizzBuzz'[i=n*2+1, i+2] #=> "uzz"

# Присвоение переменной внутри условного оператора, присвоение нужно взять в скобки иначе будет ошибка
n = 2
p 'some' if (i=n+1) > 2 && i.odd? #=> "some"
