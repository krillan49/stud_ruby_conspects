...
# Символы или метки (symbol) — это неизменяемая строка. Символы являются экземпляром (instance) класса Symbol

# Символ (метка) похож на переменную, которая ни на что не указывает, а только имеет имя
