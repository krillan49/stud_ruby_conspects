...
# Так же можно обозначать в строке какой-то другой код и VScode может его определить и разменить цветами
...
# Позволяет удобно записывать длинные строки, разбивая и складывая их, например как элементы массива:
[
