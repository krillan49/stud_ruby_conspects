...
# Проверка попадает ли какое-либо значение в диапазон с помощью === (оператора равенства регистров). когда оператор === вызывается для объекта диапазона, он возвращает true, если значение справа попадает в диапазон слева. === вызывает метод === левого объекта. (1..4) === 3 эквивалентно (1..4).=== 3. Gозиции операндов не являются взаимозаменяемыми.
(1..10) === 5      #=> true
(1..4).=== 2.345   #=> true
(1..4) === 2.345   #=> true
('a'..'j') === 'z' #=> false
