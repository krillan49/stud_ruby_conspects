...
# Блок/block - это кусок кода, что содержится между {} или do end. Нужен чтобы добавлять в методы дополнительный код. Блоки могут быть вложенными, тоесть находиться/передаваться внутри тела других блоков.
...
# 2. Создание лямбды через синтаксис "->" (lambda rocket)
my_l2 = ->(n) { n**2 }
p my_l2.call(6) #=> 36
