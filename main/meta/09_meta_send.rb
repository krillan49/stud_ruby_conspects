...
# send - альтернативный способ вызова метода (отправка сообщений объекту) который позволяет задавать имя метода через symbol или string, которые можно присваивать значениями в переменные или ключами в хэши
...
# динамически задать значения различных атрибутов объекта:
