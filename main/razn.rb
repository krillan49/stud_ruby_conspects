...
# В руби как и в скале доменная логика декомпозится в ООП и мета стилях. То есть у тебя доменные сущности моделятся классами. Внутри же методов весь обход коллекций и вся логика с ними связанная это чистое ФП, особенно если минимизировать инстанс-состояние. ruby и scala это ООП на домейн уровне и ФП на уровне работы с данными в логике
