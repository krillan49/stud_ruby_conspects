...
# В сообществе разработчиков есть разные мнения что нужно делать сначала?
# • Писать полезный код, а потом тесты?
# • Или же сначала создавать тесты, а потом код? (т.н. Test Driven Development, TDD).
# DHH (один из создателей Rails) придерживаются мнения, что сначала нужно написать код, а потом покрывать существующий код тестами
