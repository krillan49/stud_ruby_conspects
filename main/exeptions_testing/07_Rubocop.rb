...
# Пройдет все Руби фаилы проекта, в итоге выдаст список стилистических ошибок(каждая такая проверка называется 'cop') с их описаниями, а так же их колличество и сколько можно исправить автоматически
