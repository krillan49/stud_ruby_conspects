...
# Переменная экземпляра / instance variable - переменная экземпляра класса будет видна только внутри тела этого класса и доступна в каждом методе экземпляра класса.
