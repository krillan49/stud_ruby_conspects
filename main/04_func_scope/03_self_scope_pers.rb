...
# Каждый объект имеет свою собственную копию этих переменных, и их значения могут отличаться для разных объектов. Эти переменные определяют состояние объекта.
