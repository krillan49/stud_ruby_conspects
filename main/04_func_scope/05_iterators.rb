...
# upto(вверх до) - итератор принимает и итерирует значения начиная от объекта целого числа, от котрого вызван и до целого числа в параметре включительно. Работает только в порядке возрастания
