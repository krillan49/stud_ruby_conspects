...
# ORM (Object-Relational Mapping - объектно-реляционное отображение, или преобразование) — технология программирования, которая связывает базы данных с концепциями объектно-ориентированных языков программирования, создавая «виртуальную объектную базу данных». Тоесть это способ преобразовать объект из ЯП в строку в БД и наоборот

# Active record (AR) — шаблон проектирования приложений(и фрэймворк ?). AR является популярным способом доступа к данным реляционных баз данных в объектно-ориентированном программировании. Работает со всеми основными СУБД
...
# Вернет коллекцию экземпляров Client описывающих все строки в таблице clients в виде объекта класса ActiveRecord::Relation (если не создана(или нет рэйкфаила??) выдаст ошибку)
