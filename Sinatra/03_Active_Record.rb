...
# Active record (AR) — шаблон проектирования приложений(и фрэймворк ?). AR является популярным способом доступа к данным реляционных баз данных в объектно-ориентированном программировании.
...
# 2. Методы модели(методы класса) для SELECT забросов:
