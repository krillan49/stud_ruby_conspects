...
# 1. <% любой_руби_код %>     -    строка Руби кода будет выполнена, но ничего не будет выводиться на странице.
# 2. <%= любой_руби_код %>    -    строка Руби кода будет выполнена и ее возврат будет выведен в месте где стоит эта вствка
