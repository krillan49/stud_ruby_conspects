...
# https://github.com/heartcombo/devise  GitHub - plataformatec/devise: Flexible authentication solution for Rails with Warden    
...
# В Rails 7 ошибка Undefined method 'user_url' при регистрации. Нужно в config/initializers/devise.rb добавить:
